...
(defun init ()
  ...
  (load-sprite "Resources/Sheep/Happy_Sheep.aseprite")
  ...
  (load-sound "sounds/sword0.ogg")
  (load-sound "sounds/sword1.ogg")
  (load-sound "sounds/sword2.ogg")
  (load-sound "sounds/sword3.ogg")
  (load-sound "sounds/arrow0.ogg")
  (load-sound "sounds/arrow1.ogg")
  (load-sound "sounds/arrow2.ogg")
  (load-sound "sounds/arrow3.ogg")
  (load-sound "sounds/shoot0.ogg")
  (load-sound "sounds/shoot1.ogg")
  (load-sound "sounds/shoot2.ogg")
  (load-sound "sounds/shoot3.ogg")
  (load-sound "sounds/throw0.ogg")
  (load-sound "sounds/throw1.ogg")
  (load-sound "sounds/throw2.ogg")
  (load-sound "sounds/throw3.ogg")
  (load-sound "sounds/wood0.ogg")
  (load-sound "sounds/wood1.ogg")
  (load-sound "sounds/wood2.ogg")
  (load-sound "sounds/wood3.ogg")
  (load-sound "sounds/explosion0.ogg")
  (load-sound "sounds/fuse0.ogg")
  (load-sound "sounds/fire0.ogg")
  (load-sound "sounds/death0.ogg")
  (load-sound "sounds/death1.ogg")
  (load-sound "sounds/death2.ogg")
  (load-sound "sounds/death3.ogg")
  (load-sound "sounds/monster-death0.ogg")
  (load-sound "sounds/monster-death1.ogg")
  (load-sound "sounds/monster-death2.ogg")
  (load-sound "sounds/monster-death3.ogg")
  (load-sound "sounds/sheep0.ogg")
